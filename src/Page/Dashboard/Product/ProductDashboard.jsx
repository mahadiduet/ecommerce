            ...
            <table className="min-w-full bg-white shadow-md rounded-lg overflow-hidden">
                <thead>
                    <tr className="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                        ...
                        {/* <th className="py-1 px-2 text-left">Product Image</th> */}
                        <th className="py-1 px-2 text-left">Price</th>
                        <th className="py-1 px-2 text-left">Brand</th>
                    ...
                    {currentProducts.map((product, index) => (
                        <tr key={index} className="border-b border-gray-200 hover:bg-gray-100">
                            ...
                            {/* <td className="py-2 px-2 text-left">
                                <img src={product.productImage} alt={product.productImage} className="w-12 h-12 rounded-full" />
                            </td> */}
                            <td className="py-2 px-2 text-left">
