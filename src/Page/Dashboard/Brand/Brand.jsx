...
const Brand = () => {
    ...
    const currentBrands = brands.slice((currentPage - 1) * rowsPerPage, currentPage * rowsPerPage);
                ...
                <tbody className="text-gray-600 text-sm font-light">
                    {currentBrands.map((brand, index) => (
                        <tr key={index} className="border-b border-gray-200 hover:bg-gray-100">
                            ...
                            <td className="py-2 px-2 text-left whitespace-nowrap">
                                <span className="font-medium">{brand.brandCode}</span>
                            </td>
                            <td className="py-2 px-2 text-left">
                                <img src={brand.brandImage} alt={brand.brandImage} className="w-12 h-12 rounded-full" />
                            </td>
                            <td className="py-2 px-2 text-left">
                                <span>{brand.creationDateTime}</span>
                            </td>
                            <td className="py-2 px-2 text-center">
                                <div className="flex item-center justify-center space-x-4">
                                    <Link to={`/dashboard/edit_brand/${brand._id}`}>
